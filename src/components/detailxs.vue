<template>
  <v-container class="pa-0">
    <div>
      <v-card v-if="missing" dark class="justify-content-center pa-1">
        <v-img
    ...
    <v-card dark v-if="show" class="pa-2">
      ...
      <div class="d-flex justify-center">
        <div v-for="(type, index) in pokemon.types" :key="'typ' + index">
          <v-img
            v-bind:src="require(`@/assets/xltypes/${type.type.name}.png`)"
            contain
            min-height="50"
            min-width="70"
            max-height="80"
      ...
      <div class="d-flex justify-center">
        <v-btn @click="specieDialog = true" class="ma-2 mt-4" block>description</v-btn>
      </div>
      ...
      <div id="chart" style="color: black" class="d-flex justify-center">
